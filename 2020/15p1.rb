...
number when it was last spoken (the previous turn, 4) and the turn number of the
time it was most recently spoken before then (turn 1). Thus, the 5th number
spoken is 4 - 1, 3.
...
- Turn 10: 4 is new, so the 10th number spoken is 0.  (The game ends when the
Elves get sick of playing or dinner is ready, whichever comes first.)
...
(numbers.length + 1).upto(2020) do |turn|
  last = numbers[-1]
...
puts "The 2020th number spoken: #{numbers[-1]}"
