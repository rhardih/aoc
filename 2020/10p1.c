...
int main(int argc, char **argv) {
  ...
  ratings[0] = 0;
  ratings[INPUT_SIZE + 1] = ratings[INPUT_SIZE] + 3;
  ...
  printf("Number of 1-jolt differences multiplied by "
      "the number of 3-jolt differences: %d\n",
