...
long long total_power(long long grid[300][300], long long x, long long y) {
...
int main(int argc, char const *argv[]) {
  ...
  long long x, y, rack_id, plevel;
  long long tmp, ltp = 0, ltpx, ltpy;
